...
gas_rate_fig.update_layout(
    title=f"Historia de Producción de :red[Gas] del pozo: {selected_sigla}",
    xaxis_title="Meses",
...
oil_rate_fig.update_layout(
    title=f"Historia de Producción de :green[Petróleo] del pozo: {selected_sigla}",
    xaxis_title="Meses",
...
water_rate_fig.update_layout(
    title=f"Historia de Producción de :blue[Agua] del pozo: {selected_sigla}",
    xaxis_title="Meses",
